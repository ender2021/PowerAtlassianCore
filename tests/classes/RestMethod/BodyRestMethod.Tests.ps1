...
using module ..\..\..\PowerAtlassianCore\classes\RestMethod\BodyRestMethod.psm1
using module ..\..\..\PowerAtlassianCore\classes\RestMethod\RestMethodBody.psm1
using module ..\..\..\PowerAtlassianCore\classes\RestMethod\RestMethodJsonBody.psm1
